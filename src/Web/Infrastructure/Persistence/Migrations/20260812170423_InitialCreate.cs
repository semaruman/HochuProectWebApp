        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_AspNetUsers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioItems_Profiles_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSkills_Profiles_UserId",
                        column: x => x.UserId,
                        principalTable: "Profiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Deals_DealId",
                        column: x => x.DealId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealDeliverables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealDeliverables_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealDeliverableFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealDeliverableFiles_DealDeliverables_DeliverableId",
                        column: x => x.DeliverableId,
                        principalTable: "DealDeliverables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bids_ProjectId_SellerId",
                table: "Bids",
                columns: new[] { "ProjectId", "SellerId" },
                unique: true,
                filter: "\"Status\" = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealDeliverableFiles_DeliverableId",
                table: "DealDeliverableFiles",
                column: "DeliverableId");

            migrationBuilder.CreateIndex(
                name: "IX_DealDeliverables_DealId",
                table: "DealDeliverables",
                column: "DealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_Status_CategoryId",
                table: "Services",
